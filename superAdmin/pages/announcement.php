    ...
    <div class="content" id="content">
      ...
      <div style="display:flex; justify-content:flex-end; ">
        ...
        <form method="post" action="../../function/function.php">
          <a href="/capstoneweb/superAdmin/pages/newannounce.php" class="btn btn-md btn-success">
            ...
            <div class="announcement-card">
              ...
              <div class="announcement-body">
                ...
                <div class="announcement-actions">
                  ...
                  <a href="/capstoneweb/superAdmin/pages/editannouncement.php?id=<?= $rows['announce_id'] ?>"
