...
.bento-grid {
  display: grid;
  grid-template-columns: repeat(5, 1fr); /* 5 columns for desktop/laptop */
...
.ranking li span:first-child { font-weight: 500; color: #333; }
.ranking li span:last-child { color: #2c5e1a; font-weight: 600; }
...
@media (min-width: 901px) and (max-width: 1199px) {
  ...
  .bento-card.tall, .bento-card.wide {
    grid-column: span 3; /* tall/wide cards full width of grid */
    grid-row: auto;
  }
}
...
@media (max-width: 600px) {
  ...
  .stat-tile h3 { font-size: 1.3rem; }
  .stat-tile p { font-size: 0.8rem; }
  .bento-card h2 { font-size: 1.05rem; }
}
...
.announcement-item h5 { margin:0; font-size:0.98rem; color:#2c5e1a; }
.announcement-item small { color:#777; }
...
@media (max-width: 600px) {
  #sideAlerts { width: calc(100% - 24px); right: 12px; left: 12px; top: auto; bottom: 16px; }
}
...
.side-alert strong { display:block; font-size:0.95rem; color:#333; }
.side-alert small { color:#666; display:block; margin-top:4px; }
